...
class WorkerThread(QThread):
    ...
    error = Signal(str)
    segment_progress = Signal(int)  # For progress bar
    ...
    def run(self):
        try:
            ...
            res_result = subprocess.run(resolution_cmd, capture_output=True, text=True)
            ...
            if self.mode == "fast":
                ...
                for i in range(num_segments):
                    ...
                    # Break if we've processed the whole video
